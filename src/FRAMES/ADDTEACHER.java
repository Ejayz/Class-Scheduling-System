...
public class ADDTEACHER extends javax.swing.JFrame {
    ...
    public ADDTEACHER() {
        ...
        if (!new Add_Teacher().Load_Teacher(TEACHER)) {
    ...
    private void initComponents() {
        ...
        jPanel1.add(TEACHER, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 20, 270, 30));
            ...
            if (choice == 0) {
                ...
                if (new Add_Room().ValidateDelete(pass)) {
                    ...
                    if (AT.DeleteData(DAY.getSelectedItem().toString()) == 1) {
                         ...
                         if (AT.BackRoom(DAY.getSelectedItem().toString()) == 1) {
...
if(!new Add_Teacher().SearchData(SCHEDTABLE, jTextField13.getText().toString())){
    JOptionPane.showMessageDialog(this, "No data related to"+jTextField13.getText().toString());
}
    ...
    private void ADDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ADDActionPerformed
        Add_Teacher AT = new Add_Teacher();
        if (TEACHER.getSelectedItem().toString().equals("")
            ...
            AT.Splitter(SCHED.getSelectedItem().toString());
            if (AT.InsertData(TEACHER.getSelectedItem().toString(), PROGRAM.getText(), SECTION.getText(), PSCSCODE.getText(), COURSETITLE.getText(), DEPARTMENT.getText(), SUNITS.getText(), TUNITS.getText(), CONTRACTHOURS.getText(), DAY.getSelectedItem().toString(), start, end, room, REMARK.getText()) == 1) {
    ...
    private void UPDATEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UPDATEActionPerformed
        ...
        if (new RegexChecker().Checkdata(SUNITS.getText())) {
            ...
            AT.Splitter(SCHED.getSelectedItem().toString());
            if (AT.UpdateData(TEACHER.getSelectedItem().toString(), PROGRAM.getText(), SECTION.getText(), PSCSCODE.getText(), COURSETITLE.getText(), DEPARTMENT.getText(), SUNITS.getText(), TUNITS.getText(), CONTRACTHOURS.getText(), DAY.getSelectedItem().toString(), start, end, room, REMARK.getText(), Day, start, end, room) == 1) {
//                if (AT.UpdateRoom(DAY.getSelectedItem().toString(), "true") == 1) {
...
//                }
    ...
    private void DAYActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DAYActionPerformed
        ...
        } else if (TEACHER.getSelectedItem().toString().equals("--TEACHER NAME--")) {
            JOptionPane.showMessageDialog(this, "Please select teacher before selecting the day");
        } else if (!DAY.getSelectedItem().toString().equals("DAY")) {
            if (AT.LoadScheds(SCHED, DAY.getSelectedItem().toString(), TEACHER.getSelectedItem().toString()) == 0) {
    ...
    private void SCHEDTABLEMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SCHEDTABLEMouseClicked
        ...
        TEACHER.addItem(name);
        TEACHER.setSelectedItem(name);
    ...
    private void SCHEDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SCHEDActionPerformed
        if (!DAY.getSelectedItem().toString().equals("DAY")) {
            String[] Data = SCHED.getSelectedItem().toString().split("-");
            new Add_Teacher().LoadData(SECTION, COURSETITLE, DAY.getSelectedItem().toString(), Data[0], Data[1], Data[2]);
        } else {
